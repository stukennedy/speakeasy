...
export const SearchBar: FC = () => (
  <div class="relative mb-4" id="search-container" role="search">
    <div class="flex items-center bg-[#111827]/80 border border-gray-700/40 rounded-lg focus-within:border-violet-500/60 focus-within:ring-1 focus-within:ring-violet-500/20 transition-all">
      <div id="tag-bar" role="group" aria-label="Active filters" aria-live="polite" class="flex items-center gap-1 pl-3 shrink-0 flex-wrap" />
      <div class="pl-3 pr-2 text-gray-400" aria-hidden="true">
      ...
      <input
        type="text"
        id="search-input"
        class="search-input flex-1 bg-transparent text-sm text-gray-200 placeholder-gray-400 py-2.5 pr-3 min-w-[200px]"
